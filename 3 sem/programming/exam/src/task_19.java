...
//Вариант 19.
//у меня было сделать 2 точки,сделать прямую и определить по какую сторону лежат точки
...
public class task_19 extends JFrame {
    ...
    public task_19 () {
        ...
        int ans_first = Line_.compare((Point_)point_first);
        int ans_second = Line_.compare((Point_)point_second);
