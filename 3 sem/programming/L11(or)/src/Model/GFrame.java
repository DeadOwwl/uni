        ...
        openItem.addActionListener(e -> {
            ...
            try {
                ...
                while(in.hasNext()){
                    ...
                    int sectionCode=Integer.parseInt(in.nextLine());
                    String occupationType=in.nextLine();
                    String trainerFullName=in.nextLine();
                    String dateAngTimeOfBeginning=in.nextLine();
                    SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy,HH:mm");
                    Date docDate= sdf.parse(dateAngTimeOfBeginning);
                    dateAngTimeOfBeginning = sdf.format(docDate);
                    int numOfMinutes=Integer.parseInt(in.nextLine());
                    double ratePerMinute=Double.parseDouble(in.nextLine());
                    cont.add(new sportComplexUserClass(userFullName,sectionCode,occupationType,trainerFullName,dateAngTimeOfBeginning,numOfMinutes,ratePerMinute));
                }
                in.close();
                update();
